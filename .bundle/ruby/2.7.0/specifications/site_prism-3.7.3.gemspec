...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<capybara>.freeze, ["~> 3.15"])
    s.add_dependency(%q<site_prism-all_there>.freeze, [">= 0.3.1", "< 1.0"])
    s.add_dependency(%q<cucumber>.freeze, ["> 4", "< 8"])
    ...
    s.add_dependency(%q<selenium-webdriver>.freeze, [">= 3.13", "< 4.1"])
    s.add_dependency(%q<simplecov>.freeze, ["~> 0.18"])
    s.add_dependency(%q<webdrivers>.freeze, ["~> 4.6"])
  end
end
